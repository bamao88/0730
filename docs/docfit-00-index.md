...
当前已完成设计与 O0.0–O0.5 的安全事件投影、直接关联、有界历史索引、Web 会话安全和
证据重新挂载；运行总览、Agent loop 页面和跨运行比较尚未实现。
