...
- Direct migration: none. Adapt-and-reuse candidates: every row above, subject to
  license clearance and the named future contract. Retire: none until a Provider PoC
  supplies replacement evidence.
- No asset is safe to copy into the product runtime during M0.
- M1 Preflight must select the first Provider PoC, resolve license provenance, and
  replace abbreviated entries with target commit hashes for any asset approved to move.
