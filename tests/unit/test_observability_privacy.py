...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {
                "input_docx": "/private/PRIVATE_PATH_CANARY.docx",
                "output_dir": "/private/render",
                "render_intent": "candidate_verification",
                "baseline_render_ref": "/private/baseline",
                "focus_object_refs": [],
            },
            {"render_intent", "focus_ref_count", "side_effect_possible"},
        ),
        (
            "mcp__docfit__docx_visual_review",
            {
                ...
                "mode": "pages",
                "pages": [1, 2],
                "focus": ["PRIVATE_BODY_CANARY"],
            },
            {"mode", "page_count", "crop_count", "side_effect_possible"},
        ),
        (
    ...
    [
        ...
        (
            "mcp__docfit__docx_render",
            {
                ...
                "warnings": [],
                "render_ref": {
                    "document_path": "/private/PRIVATE_PATH_CANARY.docx",
                    "document_sha256": HASH_A,
                    ...
                    "dpi": 144,
                    "artifacts": {
                        "pdf": "/private/PRIVATE_PATH_CANARY.pdf",
                        "pages": ["/private/1.png", "/private/2.png"],
                    },
                },
            },
            {
