...
def build_prepare_template_prompt(prepared: PreparedTemplateTask) -> str:
    ...
    return (
        ...
        "lanes. For a blank or ambiguous run, use its parent_context label rather than positional "
        ...
        "linked by the Skill before deciding that batch; never preload every reference. Use a "
        "known field_id directly and batch uncertain meanings in template_registry. "
