...
def build_student_extraction_prompt(prepared: PreparedStudentContentExtraction) -> str:
    ...
    return (
        ...
        "chinese_chapter markers, normally map chinese_chapter to body.heading.outline1, "
        "decimal_1_component to body.heading.outline2, decimal_2_component to "
        "body.heading.outline3, and parenthesized_integer to body.numbered_list_item unless the "
