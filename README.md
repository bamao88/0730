...
evidence references without storing thesis text or controlling the conversion. O0.0–O0.3 now
provide the platform-neutral skeleton, SDK transcript/report v2 privacy boundary, and synchronous
field-allowlist projectors plus direct-ID correlation, coverage dimensions, and safe metrics;
bounded history storage and the website are not yet implemented.
